...
/* 恢复被全局 CSS 重置的样式 */
:deep(.w-e-text-container [data-slate-editor] strong),
:deep(.w-e-text-container [data-slate-editor] b) {
  font-weight: bold !important;
}

:deep(.w-e-text-container [data-slate-editor] em),
:deep(.w-e-text-container [data-slate-editor] i) {
...
/* 确保编辑器内的 span 等行内元素能够正确显示颜色和背景色 */
:deep(.w-e-text-container [data-slate-editor] span) {
  background-color: inherit; /* 允许继承背景色 */
}
